...
<div class="popup" id="popup__call"><a class="popup__close" href="#"> <img src="static/images/general/close.svg" alt=""></a>
    ...
    <form class="form">
        <label class="popup__label">
            ...
            <div class="error__label">Поле обязательно для заполнения</div>
        </label>
        <label class="popup__label">
            <input class="popup__input" type="tel" placeholder="+375 __ ___ __ __">
            <div class="error__label">Поле обязательно для заполнения</div>
        </label>
        <label class="popup__label">
            <textarea class="popup__textarea" placeholder="Комментарий (не обязательно)"></textarea>
        </label>
        <button class="btn popup-form__btn" type="submit">Отправить</button>
    </form>
</div>

<div class="popup__thanks"><a class="popup__close" href="#"> <img src="static/images/general/close.svg" alt=""></a>
    <div class="popup__title">Обратный звонок</div>
