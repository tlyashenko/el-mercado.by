    ...
    <section class="section__about">
        <div class="container">
            <div class="about__name">
                <h2 style="line-height: 50px;">Как купить хамон в Минске?</h2>
            </div>
            <div class="about__intro">
                <p>Просто перейдите в наш Телеграм-бот и оформите заказ через удобный интерфейс.
                    Наш курьер доставит его вам в удобное время.
                    Мы предлагаем разнообразие популярных сортов хамона: от классического Серрано до премиального Иберико.
                    Убедитесь в качестве наших продуктов сами!
                </p>
                ...
                <ul>
                    ...
                    <li>Надежность и отличное обслуживание.</li>
                </ul>
                <br>
